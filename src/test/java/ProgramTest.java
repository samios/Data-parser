...
public class ProgramTest {
    ...
    public void get() throws Exception {
        Program P=new Program("/home/sami/IdeaProjects/Data-parser/src/test/files/list/rapport.txt");
        P.launchP("/home/sami/IdeaProjects/Data-parser/src/test/files/list");
        ...
        assertEquals("/home/sami/IdeaProjects/Data-parser/src/test/files/list",P.getDir());
        assertEquals(expected1,P.getFiles());
        assertEquals(expected2,Scraper.getAllContents("/home/sami/IdeaProjects/Data-parser/src/test/files/list/rapport.txt"));
    }
    @Test
    public void getEmptyDir() throws Exception {
        Program P=new Program("/home/sami/IdeaProjects/Data-parser/src/test/files/test.txt");
        P.launchP("/home/sami/IdeaProjects/Data-parser/src/test/files/emptydir");
        ArrayList<String> expected1=new ArrayList<String>();
        ArrayList<ArrayList<String>> expected2=new ArrayList<ArrayList<String>>();
        assertEquals("/home/sami/IdeaProjects/Data-parser/src/test/files/emptydir",P.getDir());
        assertEquals(expected1,P.getFiles());
